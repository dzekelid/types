...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/types/master/_listings/logicbroker/apis.md
...
- name: CommerceAPI - Gets a list of all possible event types.
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/types/master/_listings/logicbroker/apiv1activityeventseventtypes-get-openapi.md
- name: CommerceAPI - Gets a list of all possible event types.
  x-api-slug: apiv1activityeventseventtypes-get
  description: Request rate limited to 10 requests per second with bursts up to 100
    requests.
